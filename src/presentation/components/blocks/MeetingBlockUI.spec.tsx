...
describe('MeetingBlockUI', () => {
  ...
  it('deve adicionar automaticamente "https://" ao link se o utilizador esquecer', () => {
    ...
    render(<MeetingBlockUI block={mockBlock} onDelete={vi.fn()} onChangeContent={mockOnChange} />);
    
    // Procura o input do link pelo placeholder
    const urlInput = screen.getByPlaceholderText('Cole o link (Zoom, Meet, Teams...)');
  ...
  it('NÃO deve adicionar "https://" se o utilizador já o tiver colocado', () => {
    ...
    fireEvent.change(urlInput, { target: { value: 'https://meet.google.com/abc' } });
