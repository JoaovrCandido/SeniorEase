...
export const Input: React.FC<InputProps> = ({ label, id, className, onDictate, onEmoji, ...props }) => {
  ...
  return (
    <div className={`${styles.container} ${className || ''}`.trim()}>
      ...
      <div className={styles.inputWrapper}>
        <input id={inputId} className={`${styles.input} ${styles.inputFlex}`} {...props} />
        {/* Renderiza o Emoji se a propriedade for passada */}
        {onEmoji && <EmojiPicker onSelect={onEmoji} title={`Emoji para ${label.toLowerCase()}`} />}
